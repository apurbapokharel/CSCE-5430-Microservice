...
public class DriverController {
    ...
    public List<Driver> listAllDrivers() {
        if (driverService.getAllDrivers() == null){
            throw new IllegalStateException("No drivers in the list");
        }
        else{
    ...
    public Driver getDriverById(@PathVariable("driverId") Long driverId) {
        if (driverService.getDriverById(driverId) == null) {
            throw new IllegalStateException("No driver with this driver ID");
        }
        else{
    ...
    @ResponseBody
    @RequestMapping("/{driverId}/name")
    public String getDriverFullName(@PathVariable("driverId") Long driverId) {
        Driver driver = driverService.getDriverById(driverId);
